...
class AlertAPITester:
    def __init__(self, base_url: str = "https://regime-intelligence.preview.emergentagent.com"):
...
def main():
    ...
    print(f"Testing backend at: https://regime-intelligence.preview.emergentagent.com")
